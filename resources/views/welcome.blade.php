...
@section('content')
    <style>
        body {
            background-image: url('{{ asset('img/backgroundwarna.png') }}');
        ...
        .section-container-items {
            ...
            background-image: url('{{ asset('img/bg1.gif') }}');
        ...
        <div class="container">
            <div class="row align-items-center h-100">
                <div class="section col-md-6">
                    <h1><span style="display: block;">Tingkatkan Potensimu</span><span
                            style="color: rgb(255, 255, 255);">dengan OneLearn!</span></h1>
                    ...
                    <a href="{{ route('register') }}"><button><i class=""></i>Daftar Sekarang</button></a>
                </div>
