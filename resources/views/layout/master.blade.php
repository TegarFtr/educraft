...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('img/logo1.png') }}" alt="" width="50px" height="50px"
                    style="margin-top: -10px">
                <img src="{{ asset('img/logoOnelearn.png') }}" alt="" width="100" height="24"
                    style="margin-top: -10px">
            </a>
            @if (Route::has('login'))
                @auth
            ...
            @if (Route::has('login'))
                <div class="d-flex justify-content-end" role="search">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{ route('login') }}" class="btn btn-custom-color">Log in</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a href="{{ route('register') }}" class="btn btn-custom-color ml-4">Register</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
    ...
    <div class="container" style="margin-top: 100px">
        <footer class="py-1 fixed-bottom bg-body-tertiary pt-3">
            <p class="text-center text-body-secondary">© 2024 OneLearn Company,inc</p>
        </footer>
    </div>
