            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-expand-lg " >
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="nav nav-underline navbar-nav me-auto mb-2 mb-lg-0" id="custom-tabs-four-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="custom-tabs-semua-materi-tab" data-toggle="pill" href="#custom-tabs-semua-materi" role="tab" aria-controls="custom-tabs-semua-materi" aria-selected="true">Kuis</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-sejarah-tab" data-toggle="pill" href="#custom-tabs-sejarah" role="tab" aria-controls="custom-tabs-sejarah" aria-selected="false">Materi</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-semua-materi" role="tabpanel" aria-labelledby="custom-tabs-semua-materi-tab">
                        <div class="row">
                            <div class="col-12 d-flex align-items-center justify-content-between">
                                <div class="d-flex">
                                    <img src="{{ asset('img/logoBintang.png') }}" width="35" height="35" alt=""><span>
                                        <h2 class="mr-auto"><b> Sosiologi </b></h2>
                                    </span>
                                </div>
                            </div>
                ...
                @endforeach
                            <div class="col-12 d-flex align-items-center justify-content-between">
                                <div class="d-flex">
                                    <img src="{{ asset('img/logoBintang.png') }}" width="35" height="35" alt=""><span>
                                        <h2 class="mr-auto"><b> Sejarah </b></h2>
                                    </span>
                                </div>
                            </div>
                            @foreach ($kuis as $key => $k)
                        ...
                        @endforeach
                            <div class="col-12 d-flex align-items-center justify-content-between">
                                <div class="d-flex">
                                    <img src="{{ asset('img/logoBintang.png') }}" width="35" height="35" alt=""><span>
                                        <h2 class="mr-auto"><b> Ekonomi </b></h2>
                                    </span>
                                </div>
                            </div>
                            @foreach ($kuis as $key => $k)
                ...
                @endforeach
                            <div class="col-12 d-flex align-items-center justify-content-between">
                                <div class="d-flex">
                                    <img src="{{ asset('img/logoBintang.png') }}" width="35" height="35" alt=""><span>
                                        <h2 class="mr-auto"><b> Geografi </b></h2>
                                    </span>
                                </div>
                            </div>
                            @foreach ($kuis as $key => $k)
                        ...
                        <div class="col-3">
                            <a href="javascript:;" data-toggle="modal" data-target="#dashboardmateri{{ $m->id }}">
                                <div class="materi_container">
                                    <div class="box">
                                        <div class="img-box">
                                            <img src="{{ asset($m->sampul) }}" class="img1" alt="">
                                        </div>
                                        <div class="detail-box">
                                            <h5>{{ $m->title }}</h5>
                                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p>{{ $m->description }}</p>
                                        <a href="{{ url('materi/bacamateri/' . $m->id) }}" class="btn btn-success">Baca Materi
                                            Sekarang</a>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
